...
function Branding() {
    return (
        <div className='flex gap-2 align-middle items-center justify-center'>
            ...
            <label className='text-xs font-bold text-base-content font-mono'>React Calculator - <a href="https://github.com/clod44/react-calculator" target='_blank' className='link font-bold text-primary'>Github</a>
            </label>
        </div>
    );
}
